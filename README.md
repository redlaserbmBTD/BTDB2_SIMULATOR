...
# Update Log
- (June 19, 2023 - v0.9.7)
   - Some code has been reorganized in the 'GameState' class definition. It should be easier now for potential collaborators to gain a high-level understanding of how the code performs simulation.
